...
class Baseline:
    def solve(self, blocked: list[list[int]], source: list[int], target: list[int]) -> bool:
...
# Signature preview: solve(self, blocked: list[list[int]], source: list[int], target: list[int])
# - blocked: e.g., [[0]]
# - source: e.g., [0]
# - target: e.g., [0]
