...
class Baseline:
    def solve(self, maze: list[list[int]], start: list[int], destination: list[int]) -> bool:
...
# Signature preview: solve(self, maze: list[list[int]], start: list[int], destination: list[int])
# - maze: e.g., [[0]]
# - start: e.g., [0]
# - destination: e.g., [0]
