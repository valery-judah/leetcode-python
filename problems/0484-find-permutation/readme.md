# 484. Using a Robot to Print the Lexicographically Smallest String
...
- [Medium] [Using a Robot to Print the Lexicographically Smallest String](../2434-using-a-robot-to-print-the-lexicographically-smallest-string/readme.md)
