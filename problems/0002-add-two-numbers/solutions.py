...
class Baseline:
    def solve(self, l1: ListNode | None, l2: ListNode | None) -> ListNode | None:
...
# Signature preview: solve(self, l1: ListNode | None, l2: ListNode | None)
# - l1: e.g., ListNode(1, ListNode(2))
# - l2: e.g., ListNode(1, ListNode(2))
TEST_CASES = [
