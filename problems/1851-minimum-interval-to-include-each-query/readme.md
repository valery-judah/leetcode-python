...
- URL: [Minimum Interval to Include Each Query](https://leetcode.com/problems/minimum-interval-to-include-each-query/)
- Function: `minInterval`
- Signature: `(intervals: list[list[int]], queries: list[int])  -> list[int]`
