...
class Baseline:
    def solve(self, root: TreeNode | None, p: int, q: int) -> TreeNode | None:
...
# Signature preview: solve(self, root: TreeNode | None, p: int, q: int)
# - root: e.g., TreeNode(1, TreeNode(2), TreeNode(3))
# - p: e.g., 0
# - q: e.g., 0
TEST_CASES = [
    ("types", (TreeNode(1, TreeNode(2), TreeNode(3)), 0, 0), {}),
]
