...
class Baseline:
    def solve(self, root: TreeNode | None, targetsum: int) -> bool:
...
# Signature preview: solve(self, root: TreeNode | None, targetsum: int)
# - root: e.g., TreeNode(1, TreeNode(2), TreeNode(3))
# - targetsum: e.g., 0
TEST_CASES = [
    ("types", (TreeNode(1, TreeNode(2), TreeNode(3)), 0), {}),
]
