# 678. Check if a Parentheses String Can Be Valid
...
- [Hard] [Special Binary String](../0761-special-binary-string/readme.md)
- [Medium] [Check if a Parentheses String Can Be Valid](../2116-check-if-a-parentheses-string-can-be-valid/readme.md)
