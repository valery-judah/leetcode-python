...
class Baseline:
    def solve(self, root: TreeNode | None, target: float, k: int) -> list[int]:
...
# Signature preview: solve(self, root: TreeNode | None, target: float, k: int)
# - root: e.g., TreeNode(1, TreeNode(2), TreeNode(3))
# - target: e.g., 0.0
# - k: e.g., 0
TEST_CASES = [
    ("types", (TreeNode(1, TreeNode(2), TreeNode(3)), 0.0, 0), {}),
]
