# 2171. Minimum Operations to Reduce X to Zero
...
- [Medium] [Minimum Moves to Equal Array Elements II](../0462-minimum-moves-to-equal-array-elements-ii/readme.md)
- [Medium] [Minimum Operations to Reduce X to Zero](../1658-minimum-operations-to-reduce-x-to-zero/readme.md)
