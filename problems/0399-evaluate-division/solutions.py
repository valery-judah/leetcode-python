...
class Baseline:
    def solve(self, equations: list[list[str]], values: list[float], queries: list[list[str]]) -> list[float]:
...
# Signature preview: solve(self, equations: list[list[str]], values: list[float], queries: list[list[str]])
# - equations: e.g., [['a']]
# - values: e.g., [0.0]
# - queries: e.g., [['a']]
