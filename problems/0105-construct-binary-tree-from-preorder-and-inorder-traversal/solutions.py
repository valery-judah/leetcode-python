...
class Baseline:
    def solve(self, preorder: list[int] | None = None, inorder: list[int] | None = None) -> TreeNode | None:
...
TEST_CASES = [
    ("types", ([0], [0]), TreeNode(1, TreeNode(2), TreeNode(3))),
    ("empty_list", ([], []), TreeNode(1, TreeNode(2), TreeNode(3))),
]
