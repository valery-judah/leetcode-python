...
class Baseline:
    def solve(self, root: TreeNode | None, subroot: TreeNode | None) -> bool:
...
# Signature preview: solve(self, root: TreeNode | None, subroot: TreeNode | None)
# - root: e.g., TreeNode(1, TreeNode(2), TreeNode(3))
# - subroot: e.g., TreeNode(1, TreeNode(2), TreeNode(3))
TEST_CASES = [
    ("types", (TreeNode(1, TreeNode(2), TreeNode(3)), TreeNode(1, TreeNode(2), TreeNode(3))), {}),
]
