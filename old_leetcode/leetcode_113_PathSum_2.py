...
class TestSolution(TestCase):
    def test(self):
        testcases = [
            TestData(name="case 1-2", root=getTree([3, 9, 20, None, None, 15, 7]),
                     target=30, expected=[[3, 20, 7]]),
            TestData(name="case 1-2", root=TreeNode(val=1, left=TreeNode(2), right=TreeNode(3)),
                     target=5, expected=[]),
            TestData(name="full case", root=getTree([5, 4, 8, 11, None, 13, 4, 7, 2, None, None, None, None, 5, 1]),
